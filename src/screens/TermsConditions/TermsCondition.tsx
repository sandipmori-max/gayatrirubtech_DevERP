            ...
            <View style={{ flexDirection: 'row' }}>
              <View style={{ width: '48%' }}>
                ...
                <Text style={styles.text}>
                  ...
                  application (“Service”). By using the Service, you agree to comply with these terms.
                </Text>
                ...
                <Text style={styles.text}>
                  DevERP requests permissions to provide app functionality. Each permission is used
                  only with your explicit consent:
                </Text>

                <Text style={styles.subText}>• Foreground Service</Text>
                <Text style={styles.text}>
                  Required to keep location tracking active when the app is in the background. A
                  persistent notification will appear to indicate the service is running.
                </Text>
                ...
                <Text style={styles.text}>
                  Used solely for capturing photos. Access occurs only after your consent.
                </Text>
              ...
              <View style={{ width: '48%' }}>
                ...
                <Text style={styles.text}>
                  You agree to use the Service only for lawful purposes and not interfere with the app
                  or servers.
                </Text>
                ...
                <Text style={styles.text}>
                  We are committed to protecting your personal data. All data is collected and used in
                  accordance with our Privacy Policy.
                </Text>
                <Text style={styles.text}>
                  We implement appropriate security measures to prevent unauthorized access, misuse,
                  or loss of data. Users may access, update, or request deletion of their data at any
                  time.{' '}
                </Text>
          ...
          >
            ...
            >
              ...
              <Text style={styles.modalText}>
                * Oeuvre collects and uses location data to enable real-time tracking, operational
                monitoring, and geofencing features.
              </Text>
              ...
              <Text style={styles.modalText}>
                * Location data is used only for app functionality and is not sold or shared for
                advertising.
              </Text>
